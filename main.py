...
SYSTEM_MESSAGE = (
    "You are DataGen, a helpful assistant that generates sample data "
    "for applications. "
    ...
    "When asked to save users, first generate them with the tool, "
    "then immediately use write_json with the result. "
...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("DataGen Agent - Gemini + LangGraph")
    print("=" * 60)
    ...
    print(
        "  - Generate users named John, Jane, Mike "
        "and save to users.json"
    )
    ...
    print(
        "  - Make users aged 25-35 "
        "with company.com emails"
    )
